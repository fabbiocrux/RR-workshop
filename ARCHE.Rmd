...
# Sprint 1: Prise en main

1) Régardez la video : [https://rstudio.cloud/learn/primers/1.2](https://rstudio.cloud/learn/primers/1.2). Timming 20Min.

2) Vous pouvez lire le de cet type. [Analyse-R](https://larmarange.github.io/analyse-R/vecteurs-indexation-et-assignation.html)
...
```
  ...
  4. Calculer le revenu minimum et maximum, mais l'un des enquetés n'a pas voulu répondre :
...
2. Ecrivez votre réponse 
3. Ecrivez votre réponse 
